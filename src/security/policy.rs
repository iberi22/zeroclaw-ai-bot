...
pub struct SecurityPolicy {
    ...
    /// Paths that are allowed even when workspace_only=true (e.g. E:\scripts-python)
...
impl SecurityPolicy {
    ...
    pub fn is_path_allowed(&self, path: &str) -> bool {
        ...
        // starts with one of the allowed_paths prefixes
    ...
    pub fn from_config(
        ...
        Self {
            ...
            allowed_paths: autonomy_config.allowed_paths.clone(),
...
mod tests {
    ...
    #[test]
    fn allowed_paths_allows_absolute_when_workspace_only() {
        // Test that paths in allowed_paths are allowed even when workspace_only=true
        let p = SecurityPolicy {
            workspace_only: true,
            allowed_paths: vec!["E:\\scripts-python".into(), "/home/user/projects".into()],
            ..SecurityPolicy::default()
        };
        // Paths in allowed_paths should be allowed
        assert!(p.is_path_allowed("E:\\scripts-python\\project1"));
        assert!(p.is_path_allowed("E:\\scripts-python\\project2\\src"));
        assert!(p.is_path_allowed("/home/user/projects/myapp"));
        // Paths NOT in allowed_paths should still be blocked
        assert!(!p.is_path_allowed("/etc/passwd"));
        assert!(!p.is_path_allowed("/tmp/file.txt"));
    }
    ...
    fn from_config_maps_all_fields() {
        let autonomy_config = crate::config::AutonomyConfig {
            ...
            allowed_paths: vec!["E:\\scripts-python".into()],
        ...
        assert_eq!(policy.allowed_paths, vec!["E:\\scripts-python"]);
