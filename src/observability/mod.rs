...
pub use self::resilience::ResilienceObserver;
...
pub fn create_observer(config: &ObservabilityConfig, workspace_dir: &Path) -> Box<dyn Observer> {
    ...
    let resilience = Box::new(ResilienceObserver::new(workspace_dir.to_path_buf()));
    Box::new(MultiObserver::new(vec![primary, resilience]))
}
...
mod tests {
    ...
    fn factory_none_returns_noop() {
        ...
        assert_eq!(create_observer(&cfg, Path::new(".")).name(), "noop");
    }
    ...
    fn factory_log_returns_log() {
        ...
        assert_eq!(create_observer(&cfg, Path::new(".")).name(), "log");
    }
    ...
    fn factory_prometheus_returns_prometheus() {
        ...
        assert_eq!(create_observer(&cfg, Path::new(".")).name(), "prometheus");
    }
    ...
    fn factory_otel_returns_otel() {
        ...
        assert_eq!(create_observer(&cfg, Path::new(".")).name(), "otel");
    }
