...
pub struct Agent {
    ...
    integration_config: crate::config::schema::IntegrationConfig,
...
impl AgentBuilder {
    ...
    pub fn build(self) -> Result<Agent> {
        ...
        Ok(Agent {
            ...
            integration_config: self.integration_config.unwrap_or_default(),
...
impl Agent {
    ...
    pub fn from_config(config: &Config) -> Result<Self> {
        ...
        Agent::builder()
            ...
            .integration_config(config.integration.clone())
            .skills({
    ...
    fn build_system_prompt(&self) -> Result<String> {
        ...
        let ctx = PromptContext {
            ...
            integration_config: Some(&self.integration_config),
